...
use crate::{
    ...
    NeedsEncryptionResponse, PluginHandler, PluginRequest, PluginResponse, ValidateAuthRequest,
...
impl<H: PluginHandler> KbsPlugin for PluginHandlerAdapter<H> {
    ...
    async fn validate_auth(
        ...
        self.handler.validate_auth(request).await
    }
    ...
    async fn needs_encryption(
        ...
        self.handler.needs_encryption(request).await
    }
}
